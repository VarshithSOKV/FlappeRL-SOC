...
pipe_image_inverse = pygame.transform.flip(pygame.transform.scale(pygame.image.load("./images/pipe.jpeg"), (70, 600)), False, True)
...
while running:
    ...
    if countdown > 0:
        ...
        if len(pipes) < 5 and (not pipes or pipes[-1].right < WIDTH // 2):
            ...
            pipe_upper = pipe_image_inverse.get_rect(midbottom=(WIDTH + 100,gap_y ))
